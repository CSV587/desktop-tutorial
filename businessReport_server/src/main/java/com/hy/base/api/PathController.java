...
public class PathController {
    ...
    /**
     * .
     * 定义映射规则是 保持报表router 与Controller的地址关系为 /reporting/{router}
     * 如果有更复杂映射需求 可以修改此方法
     *
     * @param router 路由地址
     * @return 结果对象
    ...
    private ResponseResult getPath(@PathVariable final String router) {
        return ResponseResult.success(
            "成功",
            String.format("/reporting/%s/index", router));
    }
