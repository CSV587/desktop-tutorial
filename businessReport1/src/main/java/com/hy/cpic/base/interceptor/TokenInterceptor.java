package com.hy.cpic.base.interceptor;

import com.alibaba.fastjson.JSONObject;
import com.hy.cpic.base.auth.Auth;
...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    public TokenInterceptor(Auth auth) {
        this.auth = auth;
    }
...
//    }
    ...
    private void writeInfo(HttpServletResponse response, String res) {
        try (OutputStream outputStream = response.getOutputStream()) {
            ...
            byte[] dataByteArr = res.getBytes("UTF-8");//将字符转换成字节数组，指定以UTF-8编码进行转换
